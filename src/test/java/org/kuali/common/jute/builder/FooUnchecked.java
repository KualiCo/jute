...
public final class FooUnchecked {
    ...
    private FooUnchecked(Builder builder) {
    ...
    public static FooUnchecked build() {
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<FooUnchecked> {
        ...
        @Override
        public FooUnchecked build() {
            return new FooUnchecked(this);
        }
    }
