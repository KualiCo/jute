...
public final class FooGuava2 {
    ...
    private FooGuava2(Builder builder) {
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<FooGuava2> {
        ...
        @Override
        public FooGuava2 build() {
            return validate(new FooGuava2(this));
        }

        private static FooGuava2 validate(FooGuava2 instance) {
            checkNotNull(instance.field1, "'%s' cannot be null", "field1");
            checkNotNull(instance.field2, "'%s' cannot be null", "field2");
            checkNotNull(instance.field3, "'%s' cannot be null", "field3");
            checkNotNull(instance.field4, "'%s' cannot be null", "field4");
            checkNotNull(instance.field5, "'%s' cannot be null", "field5");
            checkNotNull(instance.field6, "'%s' cannot be null", "field6");
            checkNotNull(instance.field7, "'%s' cannot be null", "field7");
            checkNotNull(instance.field8, "'%s' cannot be null", "field8");
            checkNotNull(instance.field9, "'%s' cannot be null", "field9");
            return instance;
        }
    }
