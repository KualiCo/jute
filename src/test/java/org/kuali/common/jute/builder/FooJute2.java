...
public final class FooJute2 {
    ...
    private FooJute2(Builder builder) {
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<FooJute2> {
        ...
        @Override
        public FooJute2 build() {
            return validate(new FooJute2(this));
        }

        private static FooJute2 validate(FooJute2 instance) {
            checkNotBlank(instance.field1, "field1");
            checkNotBlank(instance.field2, "field2");
            checkNotBlank(instance.field3, "field3");
            checkNotBlank(instance.field4, "field4");
            checkNotBlank(instance.field5, "field5");
            checkNotBlank(instance.field6, "field6");
            checkNotBlank(instance.field7, "field7");
            checkNotBlank(instance.field8, "field8");
            checkNotBlank(instance.field9, "field9");
            return instance;
        }
    }
