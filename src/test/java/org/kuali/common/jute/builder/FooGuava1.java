...
public final class FooGuava1 {
    ...
    private FooGuava1(Builder builder) {
    ...
    public static class Builder implements org.apache.commons.lang3.builder.Builder<FooGuava1> {
        ...
        @Override
        public FooGuava1 build() {
            return validate(new FooGuava1(this));
        }

        private static FooGuava1 validate(FooGuava1 instance) {
