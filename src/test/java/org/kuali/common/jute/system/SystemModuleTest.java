...
public class SystemModuleTest extends BaseUnitTest {

    @Test
    public void test() {
        Injector injector = createInjector(new SystemModule());
        VirtualSystem vs = injector.getInstance(VirtualSystem.class);
